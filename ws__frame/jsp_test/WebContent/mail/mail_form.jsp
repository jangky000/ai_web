...
<form name='mailForm' method='post' action="./mail_proc.jsp">
  <table class='table_basic'>
    ...
    <tr>
      ...
      <td class='td_left'><input type="text" name="to" value='test2010@gmail.com' class='input_basic' style='width: 50%;'></td>
    </tr>
    <tr>
      <th class='th_basic'>보내는 사람</th>
      <td class='td_left'><input type="text" name="from" value='test2014@gmail.com' class='input_basic' style='width: 90%;'></td>
  </tr>
  <tr>
    <th class='th_basic'>제 목</th>
    <td class='td_left'><input type="text" name="subject" value="OJT 메일을 보냅니다. IP: 4" class='input_basic' style='width: 90%;'></td>
  </tr>
  <tr>
