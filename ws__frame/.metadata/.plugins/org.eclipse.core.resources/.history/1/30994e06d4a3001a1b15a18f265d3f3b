...
<body>
  <div style="width: 50%; margin: 20px auto; outline: solid 1px gray;">
    <h4 style="padding: 20px 0;">주문 입력</h4>
    *: 필수입력
    ...
    <form name='frm' id='frm' method='POST' action='./create.do' class="form-horizontal">
      ...
      <div class="form-group">
        ...
        <div class="col-md-10">
          <input type='text' class="form-control" name='total_price' id='total_price' value='' required="required" style='width: 50%;' placeholder="주문총액">
        </div>
      </div> 
