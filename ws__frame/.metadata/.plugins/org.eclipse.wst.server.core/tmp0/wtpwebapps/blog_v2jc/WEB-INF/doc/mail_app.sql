...
BEGIN
	FOR i in 1..100 LOOP
			...
			INSERT INTO mail_app(mailno, title, content, mail_from, mail_to, rdate ) VALUES (mail_seq.nextval, '사용법', '상대의 아이피와 보낼 제목/내용을 입력해주세요', '172.16.12.4', '172.16.12.'||i, sysdate);
	END LOOP;
END;
