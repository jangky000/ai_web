 ...
 * Generated at: 2020-05-19 09:21:26 UTC
...
public final class create_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("  // 중복 확인 기능\r\n");
      out.write("  \r\n");
      out.write("  $(function(){ // -> 자동 실행된다(window.onload처럼)\r\n");
      out.write("    // id가 'btn_checkID'인 태그를 찾아서 'click' 이벤트 처리자(핸들러)로 checkID 함수를 등록\r\n");
      out.write("    $('#btn_checkID').on('click', checkID); // id와 함수명을 같게 하면 크롬에서 찾지 못하는 오류가 생길 수 있음\r\n");
      out.write("    // c.f. 자바 스크립트의 이벤트처리\r\n");
      out.write("    //document.getElementById('btn_basic').addEventListener('click', checkID);\r\n");
      out.write("  });\r\n");
      out.write("  \r\n");
      out.write("  // 이벤트 발생 시 호출됨, 콜백 함수\r\n");
      out.write("  // jQuery ajax 요청\r\n");
      out.write("   function checkID(){\r\n");
      out.write("    var frm = $('#frm'); \r\n");
      out.write("    var params = 'id=' + $('#id', frm).val(); // 키와 값의 구조, #id, #frm\r\n");
      ...
      out.write("        }\r\n");
      out.write("        \r\n");
      out.write("        // modal: 창을 못 바꾸게 하는 성질을 갖고 있음 ex. alert\r\n");
      out.write("        // 부트스트랩에서 제공하는 클래스: modal_title ... \r\n");
      ...
      out.write("    gif +=\"  <img src='./images/ani.gif' style='width: 10%;'>\";\r\n");
      out.write("    gif +=\"</div>\";\r\n");
      out.write("    \r\n");
      out.write("    $('#panel2').html(gif);\r\n");
      out.write("    $('#panel2').show(); // 숨겨진 태그의 출력 -> display: none;을 display: block;으로 바꿈 \r\n");
      out.write("    */\r\n");
      out.write("  }\r\n");
      out.write("  \r\n");
      out.write("</script>\r\n");
      ...
      out.write("    \r\n");
      out.write("  <FORM name='frm' id='frm' method='POST' action='./create.do' \r\n");
      out.write("              onsubmit=\"return send();\" class=\"form-horizontal\">\r\n");
      out.write("\r\n");
      out.write("    <div class=\"form-group\">\r\n");
      out.write("      <label for=\"id\" class=\"col-md-2 control-label\">아이디</label>    \r\n");
      out.write("      <div class=\"col-md-10\">\r\n");
      out.write("        <input type='text' class=\"form-control input-md\" name='id' id='id' value='user' required=\"required\" style='width: 30%;' placeholder=\"아이디\" autofocus=\"autofocus\">\r\n");
      ...
      out.write("                \r\n");
      out.write("    <div class=\"form-group\">\r\n");
      out.write("      <label for=\"passwd\" class=\"col-md-2 control-label\">패스워드</label>    \r\n");
      out.write("      <div class=\"col-md-10\">\r\n");
      out.write("        <input type='password' class=\"form-control input-md\" name='passwd' id='passwd' value='1234' required=\"required\" style='width: 30%;' placeholder=\"패스워드\">\r\n");
      out.write("      </div>\r\n");
      out.write("    </div>   \r\n");
      out.write("\r\n");
      out.write("    <div class=\"form-group\">\r\n");
      out.write("      <label for=\"passwd2\" class=\"col-md-2 control-label\">패스워드 확인</label>    \r\n");
      out.write("      <div class=\"col-md-10\">\r\n");
      out.write("        <input type='password' class=\"form-control input-md\" name='passwd2' id='passwd2' value='1234' required=\"required\" style='width: 30%;' placeholder=\"패스워드\">\r\n");
      out.write("      </div>\r\n");
      out.write("    </div>   \r\n");
      out.write("    \r\n");
      out.write("    <div class=\"form-group\">\r\n");
      out.write("      <label for=\"mname\" class=\"col-md-2 control-label\">성명</label>    \r\n");
      out.write("      <div class=\"col-md-10\">\r\n");
      out.write("        <input type='text' class=\"form-control input-md\" name='mname' id='mname' \r\n");
      out.write("                   value='개발자' required=\"required\" style='width: 30%;' placeholder=\"성명\">\r\n");
      out.write("      </div>\r\n");
      out.write("    </div>   \r\n");
      out.write("\r\n");
      out.write("    <div class=\"form-group\">\r\n");
      out.write("      <label for=\"tel\" class=\"col-md-2 control-label\">전화번호</label>    \r\n");
      out.write("      <div class=\"col-md-10\">\r\n");
      out.write("        <input type='text' class=\"form-control input-md\" name='tel' id='tel' \r\n");
      out.write("                   value='010-0000-0000' required=\"required\" style='width: 30%;' placeholder=\"전화번호\"> 예) 010-0000-0000\r\n");
      out.write("      </div>\r\n");
      out.write("    </div>   \r\n");
      out.write("\r\n");
      out.write("    <div class=\"form-group\">\r\n");
      out.write("      <label for=\"zipcode\" class=\"col-md-2 control-label\">우편번호</label>    \r\n");
      out.write("      <div class=\"col-md-10\">\r\n");
      out.write("        <input type='text' class=\"form-control input-md\" name='zipcode' id='zipcode' \r\n");
      out.write("                   value='12345' required=\"required\" style='width: 30%;' placeholder=\"우편번호\">\r\n");
      out.write("        <input type=\"button\" onclick=\"DaumPostcode()\" value=\"우편번호 찾기\" class=\"btn btn-info btn-md\">\r\n");
      out.write("      </div>\r\n");
      out.write("    </div>  \r\n");
      out.write("\r\n");
      out.write("    <div class=\"form-group\">\r\n");
      out.write("      <label for=\"address1\" class=\"col-md-2 control-label\">주소</label>    \r\n");
      out.write("      <div class=\"col-md-10\">\r\n");
      out.write("        <input type='text' class=\"form-control input-md\" name='address1' id='address1' \r\n");
      out.write("                   value='' required=\"required\" style='width: 80%;' placeholder=\"주소\">\r\n");
      out.write("      </div>\r\n");
      out.write("    </div>   \r\n");
      out.write("\r\n");
      out.write("    <div class=\"form-group\">\r\n");
      out.write("      <label for=\"address2\" class=\"col-md-2 control-label\">상세 주소</label>    \r\n");
      out.write("      <div class=\"col-md-10\">\r\n");
      out.write("        <input type='text' class=\"form-control input-md\" name='address2' id='address2' \r\n");
      out.write("                   value='' required=\"required\" style='width: 80%;' placeholder=\"상세 주소\">\r\n");
      out.write("      </div>\r\n");
      out.write("    </div>   \r\n");
      out.write("\r\n");
      out.write("    <div class=\"form-group\">\r\n");
      ...
      out.write("        <button type=\"submit\" class=\"btn btn-primary btn-md\">가입</button>\r\n");
