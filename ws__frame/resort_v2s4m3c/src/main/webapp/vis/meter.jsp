...
<script type="text/javascript">
  var auto_reload = null; // 자동 실행 객체 선언
  $(function() { // 자동 실행
    auto_reload = setInterval(meter, 3000); // 3초마다 meter 함수를 호출
  ...
  function meter() {
    // alert('자동 호출됨');
    var params = 'code=METER'; // code: 차트의 종류
    var msg = '';
      ...
      $.ajax({
        ...
        success: function(rdata) { // 서버로부터 성공적으로 응답이 온경우
          ...
          $.jqplot('chart_panel',[data],{ // 2차원 배열의 형태
              seriesDefaults: {
