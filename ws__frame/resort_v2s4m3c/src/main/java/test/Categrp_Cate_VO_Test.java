...
public class Categrp_Cate_VO_Test {
  ...
  public static void main(String[] args) {
    ...
    CateVO _cateVO = new CateVO(1, 1, "좀비", 1, "Y", "2020-05-13", 0);
    
    Categrp_Cate_VO categrp_Cate_VO = new Categrp_Cate_VO();
    categrp_Cate_VO.setCategrpVO(_categrpVO); // call by reference
    categrp_Cate_VO.setCateVO(_cateVO); // call by reference
