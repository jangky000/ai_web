...
public class NoticeDAO {
   ...
   */
  // 목록은 ArrayList를 사용하여 개발
  public ArrayList<NoticeVO> list(int startNum, int endNum){
    ArrayList<NoticeVO> list = new ArrayList<NoticeVO>();
    //NoticeVO vo = new NoticeVO();
    ...
    try {
      ...
      sql = new StringBuffer();
      sql.append(" SELECT noticeno, title, rname, passwd, rdate, r");
      sql.append(" FROM(");
      sql.append("         SELECT noticeno, title, rname, passwd, rdate, rownum as r");
      sql.append("         FROM(");
      sql.append("                 SELECT noticeno, title, rname, passwd, rdate");
      sql.append("                 FROM notice");
      sql.append("                 ORDER BY noticeno DESC");
      sql.append("         )");
      sql.append(" )");
