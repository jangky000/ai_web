...
<jsp:include page="/menu/top.jsp" flush='false' />
  ...
  <button type="button" onclick="location.href='./list.jsp?nowPage=<%=nowPage %>&recordPerPage=<%= recordPerPage%>'">목록</button>
    <button type="button" onclick="location.href='./update_form.jsp?noticeno=<%= noticeno%>&nowPage=<%=nowPage %>&recordPerPage=<%= recordPerPage%>'">수정</button>
    <button type="button" onclick="location.href='./delete_form.jsp?noticeno=<%= noticeno%>&nowPage=<%=nowPage %>&recordPerPage=<%= recordPerPage%>'">삭제</button>
  </div>
