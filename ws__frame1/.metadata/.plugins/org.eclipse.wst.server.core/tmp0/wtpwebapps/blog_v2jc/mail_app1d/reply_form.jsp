...
<jsp:include page="/menu/top.jsp" flush='false' />
  <div class="title_line"><%=application_title %>＞답장</div>
    ...
    <fieldset class="fieldset_basic">
      ...
      <ul>
        ...
        <li class="li_none">
          ...
          <input class="input_basic" type="text" name="mail_to" style="width: 200px;" value="<%= mailVO.getMail_from()%>">
        </li>
        <li class="li_none">
          <label style="vertical-align: top;">내용: </label>
          <textarea name="content" style="width: 80%; height: 150px;"><%=mailVO.getContent() %>
----------------------------------------------------------------------------------------------------
        ...
        <tr>
          ...
          <td style="padding-left: 10px; border: solid 1px #999999;">
            ...
            if(mailVO.getUrl1() == null){
              %>
              <input class="input_basic" type="text" name="url1" style="width: 100%;">
              <%
            } else {
              %>
        ...
        <tr>
          ...
          <td style="padding-left: 10px; border: solid 1px #999999;">
            ...
            if(mailVO.getUrl2() == null){
              %>
              <input class="input_basic" type="text" name="url2" style="width: 100%;">
              <%
            } else {
              %>
              <input class="input_basic" type="text" name="url2" style="width: 100%;" value="<%= mailVO.getUrl1()%>">
              <%
            }
            %>
          </td>
        ...
        <tr>
          ...
          <td style="padding-left: 10px; border: solid 1px #999999;">
            ...
            if(mailVO.getYoutube() == null){
              ...
              %>
              <input class="input_basic" type="text" name="url2" style="width: 100%;" value="<%= mailVO.getYoutube()%>">
              <%
            }
            %>
          </td>
