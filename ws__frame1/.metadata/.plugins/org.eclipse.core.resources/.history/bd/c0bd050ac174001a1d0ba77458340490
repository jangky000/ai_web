...
*/
  ...
  public MailVO(int mailno, String title, String content, String mail_from, String mail_to, String rdate) {
    this.mailno = mailno;
    this.title = title;
  ...
  public MailVO(String title, String content, String mail_from, String mail_to) {
    this.title = title;
    this.content = content;
    this.mail_from = mail_from;
    this.mail_to = mail_to;
